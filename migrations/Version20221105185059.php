 ...
 */
final class Version20221105185059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E963379586 FOREIGN KEY (comments_id) REFERENCES comment (id)');
